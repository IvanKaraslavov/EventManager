...
namespace EventManager.EventManagerDataSetTableAdapters {
    ...
    public partial class EventTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Event] WHERE (([id] = @Original_id) AND ([name] = @Original_na" +
                "me) AND ([location] = @Original_location) AND ([start] = @Original_start) AND ([" +
                "end] = @Original_end))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Event] ([name], [location], [start], [end]) VALUES (@name, @lo" +
                "cation, @start, @end);\r\nSELECT id, name, location, start, [end] FROM Event WHERE" +
                " (id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Event] SET [name] = @name, [location] = @location, [start] = @start, [end] = @end WHERE (([id] = @Original_id) AND ([name] = @Original_name) AND ([location] = @Original_location) AND ([start] = @Original_start) AND ([end] = @Original_end));
SELECT id, name, location, start, [end] FROM Event WHERE (id = @id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT id, name, location, start, [end] FROM dbo.Event";
        ...
        public virtual int Fill(EventManagerDataSet.EventDataTable dataTable) {
        ...
        public virtual EventManagerDataSet.EventDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            EventManagerDataSet.EventDataTable dataTable = new EventManagerDataSet.EventDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(EventManagerDataSet.EventDataTable dataTable) {
        ...
        public virtual int Delete(int Original_id, string Original_name, string Original_location, System.DateTime Original_start, System.DateTime Original_end) {
        ...
        public virtual int Update(string name, string location, System.DateTime start, System.DateTime end, int Original_id, string Original_name, string Original_location, System.DateTime Original_start, System.DateTime Original_end, int id) {
            if ((name == null)) {
                throw new global::System.ArgumentNullException("name");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string name, string location, System.DateTime start, System.DateTime end, int Original_id, string Original_name, string Original_location, System.DateTime Original_start, System.DateTime Original_end) {
            return this.Update(name, location, start, end, Original_id, Original_name, Original_location, Original_start, Original_end, Original_id);
        }
    }
